...
//        CheckMouseOnUI();
        ...
        if (Input.touchCount > 0)
        {
            ...
            if (Input.touchCount == 3)
            {
                ...
                {
                    kTarget.Translate(mTrans.right * -Input.GetTouch(0).deltaPosition.x * Time.deltaTime * panSpeed);
                    kTarget.Translate(mTrans.up * -Input.GetTouch(0).deltaPosition.y * Time.deltaTime * panSpeed);
                }
            }
        ...
        {
            _isFocus = false;
			kTarget.Translate(mTrans.right * -Input.GetAxis("Mouse X") * Time.deltaTime * panSpeed, Space.World);
            kTarget.Translate(mTrans.up * -Input.GetAxis("Mouse Y") * Time.deltaTime * panSpeed, Space.World);
            kTarget.position = new Vector3(kTarget.position.x, 0, kTarget.position.z);
        }
        #endregion
...
//        Vector3 position = rotation * new Vector3(0f, 0f, -perDistance);
