...
namespace Imagine.WebAR
{
    ...
    public class ImageTracker : MonoBehaviour
    {
        ...
        [SerializeField] public UnityEvent<string> OnImageFound, OnImageLost;
        ...
        public void SetTargetChildEnable(int index)
        {
            if(mCurTarget)
            {
                for (int i = 0; i< mCurTarget.childCount; i++)
                    mCurTarget.GetChild(i).gameObject.SetActive(i == index);
            }
        }
        ...
        void OnTrackingFound(string id)
        {
            ...
            mCurTarget = targets[id].transform;
            mCurTarget.gameObject.SetActive(true);
            for (int i = 0; i < mCurTarget.childCount; i++)
            {
                mCurTarget.GetChild(i).gameObject.SetActive(i == 0);
            }
